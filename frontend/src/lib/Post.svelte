...
<div class="flex space-x-10 max-w-200 portrait:flex-col space-y-3">
  <div class="flex-row space-y-2">
    ...
    {#if admin % 3 == 1}
      <button class="flex flex-row space-x-2 justify-center max-w-sm mx-auto bg-gray-200 hover:bg-gray-300 text-black inter-body text-sm w-full py-2 px-4 rounded mr-2" on:click={editClick}>
    ...
    {#if admin % 3 == 2}
      <button class="flex flex-row space-x-2 justify-center max-w-sm mx-auto bg-gray-200 hover:bg-gray-300 text-black inter-body text-sm w-full py-2 px-4 rounded mr-2" on:click={deleteClick} >
