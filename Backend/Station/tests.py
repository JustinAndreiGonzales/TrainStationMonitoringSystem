...
class TestViews(APITestCase):
    def setUp(self):
        ...
        Station.objects.create(id=25, stationName="J. Ruiz", trainLine="LRT2", leftETA="2025-02-23T05:00:00Z", rightETA="2025-02-23T05:00:00Z", leftCurrentDensity="Heavy", rightCurrentDensity="Light", leftCCTV="", rightCCTV="", isOperating=True, stationImage="")
    ...
    def test_get_specific_station(self):
        ...
        self.assertEqual(res.data["stationImage"], "")
