...
class TestViews(APITestCase):
    def setUp(self):
        ...
        self.selected = Station.objects.create(id=2, stationName="Balintawak", trainLine="LRT1", leftETA=10, rightETA=3, leftCurrentDensity="Heavy", rightCurrentDensity="Light", leftCCTV="https://res.cloudinary.com/stations-cctv/video/upload/station_left_cctv_sample.mp4", rightCCTV="https://res.cloudinary.com/stations-cctv/video/upload/station_right_cctv_sample.mp4", isOperating=True, stationIMG="")
        ...
        Station.objects.create(id=25, stationName="J. Ruiz", trainLine="LRT2", leftETA=10, rightETA=3, leftCurrentDensity="Heavy", rightCurrentDensity="Light", leftCCTV="", rightCCTV="", isOperating=True, stationIMG="")
